-- book statistics of a book (non aggregated!) containing the sales, expenditure included with a book's inital attributes
...
-- View of sales per genre, simply sum of sales with genre
...
-- View of sales, and quantity of books sold per author
